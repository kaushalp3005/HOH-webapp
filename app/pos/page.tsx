...
export default function PointOfSalePage() {
  ...
  const handleScannerSubmit = useCallback(() => {
    ...
    if (!hasScannerSyncedRef.current) {
      ...
      // NOTE: Do NOT reset scanner pages here - they need to persist
      // so the barcode count can be displayed in the Actions modal.
      // The reset happens in handleConfirmPayment after successful payment.
    }
  ...
  const handleOpenScanner = () => {
    ...
    // Only reset scanner pages and sync flag if there are no items
    // This preserves existing scanned items for the barcode count display
